          ...
          <div className="main-parent-forsale-container">
            ...
            <div className="center-center">
              <div className="forsale-nontitle-input-container">
                ...
                <input className="form-right-input input forsale-input" type="text" pattern="(\d{5}([\-]\d{4})?)" required placeholder="Zip Code" onChange={(event) => { this.props.state.zipcode = event.target.value }} />
              </div>
            </div>
            ...
            <div className="center-center">
              <div className="forsale-nontitle-2nd">
                ...
                <input className="input forsale-input" type="text" required placeholder="Contact Name" onChange={(event) => { this.props.state.contactName = event.target.value }} />
                
                
                <input className="form-right-input input forsale-input" type="text" required placeholder="Phone Number" onChange={(event) => { this.props.state.phoneNumber = event.target.value }} />

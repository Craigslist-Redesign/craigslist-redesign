          ...
          <div className="main-parent-forsale-container">
            ...
            <div className="center-center">
              <div className="forsale-nontitle-input-container">
                <input className="form-left-input input forsale-input" type="text" required placeholder="Location" onChange={(event) => { this.props.state.location = event.target.value }} />
            ...
            <div className="center-center">
              <div className="forsale-nontitle-2nd">
                <input className="form-left-input input forsale-input" type="text" required placeholder="Contact Name" onChange={(event) => { this.props.state.contactName = event.target.value }} />
                <input className="input forsale-input" type="text" required placeholder="Phone Number" onChange={(event) => { this.props.state.phoneNumber = event.target.value }} />
              </div>
            </div>
